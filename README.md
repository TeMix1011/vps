...
```sh
$ wget https://raw.githubusercontent.com/TeMix1011/vps/edit/master/centos-kvm.sh
...
```sh
$ wget https://raw.githubusercontent.com/TeMix1011/vps/edit/master/centos-kvm.sh && chmod +x centos-kvm.sh && sh centos-kvm.sh
```
